  ...
  return (
    <>
      <section>
        <h1>Get Started</h1>
        <p>
          Before getting started, you’ll need to have the following documents
          ready.
        </p>
        <ul>
          <li>
            Payment receipt from{' '}
            <Link href="https://katyisd.revtrak.net/high-schools/cinco-ranch-high-school/crhs-parking/">
              Pay N’ Go
            </Link>
          </li>
